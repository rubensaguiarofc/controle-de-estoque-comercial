...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "") ?? undefined,
    authDomain: ("TURBOPACK compile-time value", "") ?? undefined,
    projectId: ("TURBOPACK compile-time value", "") ?? undefined,
    storageBucket: ("TURBOPACK compile-time value", "") ?? undefined,
    messagingSenderId: ("TURBOPACK compile-time value", "") ?? undefined,
    appId: ("TURBOPACK compile-time value", "") ?? undefined,
    measurementId: ("TURBOPACK compile-time value", "") ?? undefined
};
...
"[project]/src/firebase/offline.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"use client";
;
async function setupOffline(app) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enableIndexedDbPersistence"])(db);
    } catch (e) {
...
_s(useUser, "/DfDfj7Y8lL6lf3uqfppJw8yM+U=", false, function() {
    return [
...
{
__turbopack_context__.s({
    "getInitializedApp": (()=>getInitializedApp),
    "getInitializedAuth": (()=>getInitializedAuth),
    "getInitializedFirestore": (()=>getInitializedFirestore),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$firestore$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$offline$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/offline.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-client] (ecmascript)");
...
async function initializeFirebase() {
    ...
    try {
        firestore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$offline$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupOffline"])(firebaseApp);
    } catch (e) {
...
function FirebaseProvider({ children }) {
    ...
    let firestore = null;
    try {
        firebaseApp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getInitializedApp"])();
    } catch  {
        firebaseApp = null;
    }
    try {
        auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getInitializedAuth"])();
    } catch  {
        auth = null;
    }
    try {
        firestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getInitializedFirestore"])();
    } catch  {
        firestore = null;
    }
...
_s1(useFirebaseApp, "yuaHhIQdjDN+C43d5KrX24ScWeI=", false, function() {
    return [
        useFirebase
    ];
});
...
_s2(useAuth, "yuaHhIQdjDN+C43d5KrX24ScWeI=", false, function() {
    return [
        useFirebase
    ];
});
...
_s3(useFirestore, "yuaHhIQdjDN+C43d5KrX24ScWeI=", false, function() {
    return [
        useFirebase
    ];
});
...
function FirebaseClientProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FirebaseClientProvider.useEffect": ()=>{
            let mounted = true;
            ({
                "FirebaseClientProvider.useEffect": async ()=>{
                    try {
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initializeFirebase"])();
                    } finally{
...
_s(FirebaseClientProvider, "KuazqYXqOk+6VRk8yHVvoClyoeE=");
...
//# sourceMappingURL=src_d1a96934._.js.map